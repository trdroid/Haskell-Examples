...
Haskell Platform can be downloaded from https://www.haskell.org/platform/

Other downloads are available at https://www.haskell.org/downloads

**Verifying the installation**

On Git Bash, entering *ghci*, gives a warning
...
Optionally, Haskell Tool Stack can be downloaded from https://docs.haskellstack.org/en/stable/README/
...
Usage: stack.exe [--help] [--version] [--numeric-version]
                 ...
                 [--stack-root STACK-ROOT] [--work-dir WORK-DIR]
                 [--[no-]system-ghc] [--[no-]install-ghc] [--arch ARCH]
                 [--os OS] [--ghc-variant VARIANT] [-j|--jobs JOBS]
